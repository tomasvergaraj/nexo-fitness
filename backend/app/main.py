...
app.include_router(operations.audit_router, prefix=prefix)
...
app.include_router(operations.feedback_router, prefix=prefix)
app.include_router(operations.gift_cards_router, prefix=prefix)
