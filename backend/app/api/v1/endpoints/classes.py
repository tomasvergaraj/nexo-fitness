...
# Helpers puros movidos a services/checkin_helpers.py.
# Aliases con prefijo `_` se mantienen para retrocompatibilidad con tests.
from app.services.checkin_helpers import (  # noqa: E402
    build_checkin_response as _build_checkin_response,
    checkin_case_response as _checkin_case_response,
    checkin_history_response as _checkin_history_response,
    ensure_class_bookable as _ensure_class_bookable,
    parse_qr_payload as _parse_qr_payload,
)
