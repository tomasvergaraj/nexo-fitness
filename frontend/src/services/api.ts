...
export const mobileApi = {
  ...
  getReferral: () => api.get<{ code: string | null; share_url: string | null; referred_count: number; reward_enabled: boolean; reward_days: number; rewards_earned_days: number }>('/mobile/refer'),
